...
ALL_1A <- collapse_rows_df(ALL_EXCL_MISC_TABLE_1A, Model) %>% 
  ...
  kable_classic(full_width = T, html_font = "Cambria", font_size = 16, "striped")
...
### Save Tables to CSV
```{r}
write_csv(ALL_EXCL_MISC_TABLE_1A, "2A_NER_PERFORMANCE.csv")
write_csv(ALL_EXCL_MISC_TABLE_1B, "2B_NER_PERFORMANCE.csv")
